...
// 2014/10/25 시작
	...
	*/
	...
	// area->addr: (kmem_cache#30-oX (vm_struct))->addr: 0xf0006000
	...
	if (DOMAIN_IO == 0 &&
		...
		// addr: 0xf0006000, size: 0x1000, paddr: 0x101C0000,
		// type->prot_pte: (&mem_types[0])->prot_pte: PROT_PTE_DEVICE | L_PTE_MT_DEV_SHARED | L_PTE_SHARED (0x653)
		// ioremap_page_range(0xf0006000, 0xf0007000, 0x101C0000, PROT_PTE_DEVICE | L_PTE_MT_DEV_SHARED | L_PTE_SHARED (0x653)): 0
	...
	unsigned int mtype, void *caller)
{
	...
	// pfn: 0x101C0, offset: 0, size: 0x800, mtype: MT_DEVICE: 0, caller: __builtin_return_address(0)
	// __arm_ioremap_pfn_caller(0x101C0, 0, 0x800, MT_DEVICE: 0, __builtin_return_address(0)): 0xf0006000
...
__arm_ioremap(phys_addr_t phys_addr, size_t size, unsigned int mtype)
{
	...
	// arch_ioremap_caller(0x101C0000, 0x800, MT_DEVICE: 0, __builtin_return_address(0)): 0xf0006000
