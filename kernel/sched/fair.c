...
// ARM10C 20171011
// &cfs_rq->load: [pcp0] &(&(&runqueues)->cfs)->load,
// se->load.weight: (&(kmem_cache#15-oX (struct task_struct))->se)->load.weight: 1024
// ARM10C 20171011
// &rq_of([pcp0] &(&runqueues)->cfs)->load: [pcp0] &(&runqueues)->load
// se->load.weight: (&(kmem_cache#15-oX (struct task_struct))->se)->load.weight: 1024
...
{
	// lw->weight: [pcp0] (&(&(&runqueues)->cfs)->load)->weight: 1024, dec: 1024
	// lw->weight: [pcp0] (&(&runqueues)->load)->weight: 1024, dec: 1024
	lw->weight -= dec;
	// lw->weight: [pcp0] (&(&(&runqueues)->cfs)->load)->weight: 0
	// lw->weight: [pcp0] (&(&runqueues)->load)->weight: 0
...
// 2017/05/13 시작
		...
		// cfs_rq->on_list: [pcp0] (&(&runqueues)->cfs)->on_list: 0
		cfs_rq->on_list = 1;
		// cfs_rq->on_list: [pcp0] (&(&runqueues)->cfs)->on_list: 1
...
// entry: &(kmem_cache#15-oX (struct task_struct))->se (pid 1)
static inline int entity_before(struct sched_entity *a,
				struct sched_entity *b)
{
	// NOTE:
	// (&(kmem_cache#15-oX (struct task_struct))->se (pid 2))->vruntime 의 값과
	// (&(kmem_cache#15-oX (struct task_struct))->se (pid 1))->vruntime 의 값이
	// 같은 것으로 가정하고 분석 진행

	// a->vruntime: (&(kmem_cache#15-oX (struct task_struct))->se (pid 2))->vruntime,
	// b->vruntime: (&(kmem_cache#15-oX (struct task_struct))->se (pid 1))->vruntime
...
static void __enqueue_entity(struct cfs_rq *cfs_rq, struct sched_entity *se)
{
	...
	// *link: [pcp0] (&(&runqueues)->cfs)->tasks_timeline.rb_node: &(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1)
	while (*link) {
		// parent: NULL, *link: [pcp0] (&(&runqueues)->cfs)->tasks_timeline.rb_node: &(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1)
		parent = *link;
		// parent: &(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1)

		// parent: &(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1)
		// rb_entry(&(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1), struct sched_entity, run_node):
		// &(kmem_cache#15-oX (struct task_struct))->se
		entry = rb_entry(parent, struct sched_entity, run_node);
		// entry: &(kmem_cache#15-oX (struct task_struct))->se
		...
		// se: &(kmem_cache#15-oX (struct task_struct))->se (pid 2),
		// entry: &(kmem_cache#15-oX (struct task_struct))->se (pid 1)
		// entity_before(&(kmem_cache#15-oX (struct task_struct))->se (pid 2), &(kmem_cache#15-oX (struct task_struct))->se (pid 1)): 0
		if (entity_before(se, entry)) {
			link = &parent->rb_left;
		} else {
			// &parent->rb_right: &(&(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1))->rb_right
			link = &parent->rb_right;
			// link: &(&(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1))->rb_right
	...
	// link: [pcp0] &(&(&runqueues)->cfs)->tasks_timeline.rb_node
	// &se->run_node: &(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 2),
	// parent: &(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1),
	// link: &(&(&(kmem_cache#15-oX (struct task_struct))->se)->run_node (pid 1))->rb_right
...
// cfs_rq: [pcp0] &(&runqueues)->cfs, se: &(kmem_cache#15-oX (struct task_struct))->se
// ARM10C 20170201
// task_cfs_rq(kmem_cache#15-oX (struct task_struct)): [pcp0] &(&runqueues)->cfs, &p->se: &(kmem_cache#15-oX (struct task_struct))->se
...
void init_task_runnable_average(struct task_struct *p)
{
	...
	// p->se.avg.decay_count: (kmem_cache#15-oX (struct task_struct))->se.avg.decay_count
	p->se.avg.decay_count = 0;
	// p->se.avg.decay_count: (kmem_cache#15-oX (struct task_struct))->se.avg.decay_count: 0

	// p: kmem_cache#15-oX (struct task_struct), task_cfs_rq(kmem_cache#15-oX (struct task_struct)): [pcp0] &(&runqueues)->cfs,
	// &p->se: &(kmem_cache#15-oX (struct task_struct))->se
	// sched_slice([pcp0] &(&runqueues)->cfs, &(kmem_cache#15-oX (struct task_struct))->se): 현재 task의 남아 있는 수행 시간량
	slice = sched_slice(task_cfs_rq(p), &p->se) >> 10;
	// slice: 현재 task의 남아 있는 수행 시간량 / 1024

	// slice: 현재 task의 남아 있는 수행 시간량 / 1024
	// p->se.avg.runnable_avg_sum: (kmem_cache#15-oX (struct task_struct))->se.avg.runnable_avg_sum
	p->se.avg.runnable_avg_sum = slice;
	// p->se.avg.runnable_avg_sum: (kmem_cache#15-oX (struct task_struct))->se.avg.runnable_avg_sum: 현재 task의 남아 있는 수행 시간량 / 1024

	// slice: 현재 task의 남아 있는 수행 시간량 / 1024
	// p->se.avg.runnable_avg_period: (kmem_cache#15-oX (struct task_struct))->se.avg.runnable_avg_period
	p->se.avg.runnable_avg_period = slice;
	// p->se.avg.runnable_avg_period: (kmem_cache#15-oX (struct task_struct))->se.avg.runnable_avg_period: 현재 task의 남아 있는 수행 시간량 / 1024

	// &p->se: &(kmem_cache#15-oX (struct task_struct))->se
	__update_task_entity_contrib(&p->se);

	// __update_task_entity_contrib 에서 한일:
...
// 2017/10/11 시작
	...
	// [20170906] cfs_rq: [pcp0] &(&runqueues)->cfs, delta_exec: 실행된 시간차이값
	account_cfs_rq_runtime(cfs_rq, delta_exec); // null function
}
...
// cfs_rq: [pcp0] &(&runqueues)->cfs, rq_of([pcp0] &(&runqueues)->cfs): [pcp0] &runqueues
// se: &(kmem_cache#15-oX (struct task_struct) (pid: 1))->se
// task_of(&(kmem_cache#15-oX (struct task_struct) (pid: 1))->se): kmem_cache#15-oX (struct task_struct) (pid: 1)
...
account_entity_enqueue(struct cfs_rq *cfs_rq, struct sched_entity *se)
{
	...
	if (entity_is_task(se)) {
		...
		// list_add 에서 한일:
		// [pcp0] &(&runqueues)->cfs_tasks 란 list head에 &(&(kmem_cache#15-oX (struct task_struct))->se)->group_node 를 추가함 (pid 1)
...
account_entity_dequeue(struct cfs_rq *cfs_rq, struct sched_entity *se)
{
	...
	// se: &(kmem_cache#15-oX (struct task_struct) (pid: 1))->se
	// entity_is_task(&(kmem_cache#15-oX (struct task_struct) (pid: 1))->se): 1
	if (entity_is_task(se)) {
		// cfs_rq: [pcp0] &(&runqueues)->cfs, rq_of([pcp0] &(&runqueues)->cfs): [pcp0] &runqueues
		// se: &(kmem_cache#15-oX (struct task_struct) (pid: 1))->se
		// task_of(&(kmem_cache#15-oX (struct task_struct) (pid: 1))->se): kmem_cache#15-oX (struct task_struct) (pid: 1)
		account_numa_dequeue(rq_of(cfs_rq), task_of(se)); // null function
...
// ARM10C 20170513
// cfs_rq->blocked_load_avg: [pcp0] (&(&runqueues)->cfs)->blocked_load_avg: 0, decays: 시간값x
static __always_inline u64 decay_load(u64 val, u64 n)
{
	unsigned int local_n;

	// NOTE:
	// schedule 시간값>> 20 은 0이 아닌 상수 값, 2016 보다 작은 값이라 가정하고 코드 분석 진행

	// NOTE:
	// 시간값x 은 0이 아닌 상수 값, 2016 보다 작은 값이라 가정하고 코드 분석 진행

	// n: schedule 시간값>> 20, LOAD_AVG_PERIOD: 32
	// n: 시간값x, LOAD_AVG_PERIOD: 32
	if (!n)
		return val;
...
// 2017/04/10 시작
	...
	// NOTE:
	// 시간값x 은 0이 아닌 상수 값, 32보다 작은 값이라 가정하고 코드 분석 진행

	// local_n: schedule 시간값>> 20, LOAD_AVG_PERIOD: 32
	// local_n: 시간값x, LOAD_AVG_PERIOD: 32
							...
							int runnable)
{
	...
	// now: 현재의 schedule 시간값,
	// sa->last_runnable_update: (&(&(kmem_cache#15-oX (struct task_struct))->se)->avg)->last_runnable_update: 현재의 schedule 시간값
	delta = now - sa->last_runnable_update;
	// delta: 현재의 schedule 시간 변화값

	// NOTE:
	// delta: 현재의 schedule 시간 변화값은 signed 로 변경시
	// 0 보다 큰 값으로 가정하고 코드 분석 진행
	...
	// delta: 현재의 schedule 시간 변화값
	delta >>= 10;
	// delta: 현재의 schedule 시간 변화값 >> 10

	// NOTE:
	// delta: 현재의 schedule 시간 변화값 >> 10 은 0 아닌 값으로 가정하고 코드 분석 진행
	...
	// sa->runnable_avg_period: (&(&(kmem_cache#15-oX (struct task_struct))->se)->avg)->runnable_avg_period: 현재 task의 남아 있는 수행 시간량 / 1024
	delta_w = sa->runnable_avg_period % 1024;
	// delta_w: 현재 task의 남아 있는 수행 시간량 / 1024 % 1024

	// NOTE:
	// delta + delta_w 값이 1024 보다 작은 값이라고 가정하고 코드 분석 진행

	// delta: 현재의 schedule 시간 변화값 >> 10, delta_w: 현재 task의 남아 있는 수행 시간량 / 1024 % 1024
	...
	// runnable: 1
	if (runnable)
		// sa->runnable_avg_sum: (&(&(kmem_cache#15-oX (struct task_struct))->se)->avg)->runnable_avg_sum: 현재 task의 남아 있는 수행 시간량 / 1024,
		// delta: 현재의 schedule 시간 변화값
		sa->runnable_avg_sum += delta;
		// sa->runnable_avg_sum: (&(&(kmem_cache#15-oX (struct task_struct))->se)->avg)->runnable_avg_sum:
		// 현재 task의 남아 있는 수행 시간량 / 1024 + 현재의 schedule 시간 변화값

	// sa->runnable_avg_period: (&(&(kmem_cache#15-oX (struct task_struct))->se)->avg)->runnable_avg_period: 현재 task의 남아 있는 수행 시간량 / 1024,
	// delta: 현재의 schedule 시간 변화값
	sa->runnable_avg_period += delta;
	// sa->runnable_avg_period: (&(&(kmem_cache#15-oX (struct task_struct))->se)->avg)->runnable_avg_period:
	// 현재 task의 남아 있는 수행 시간량 / 1024 + 현재의 schedule 시간 변화값
...
// ARM10C 20170513
// cfs_rq: [pcp0] &(&runqueues)->cfs, force_update: 0
						 ...
						 int force_update)
{
	...
	// tg_contrib: 현재 task의 남아 있는 수행 시간량 / (현재 task의 남아 있는 수행 시간량 / 1024 + 1),
	// cfs_rq->tg_load_contrib: [pcp0] (&(&runqueues)->cfs)->tg_load_contrib: 현재 task의 남아 있는 수행 시간량 / (현재 task의 남아 있는 수행 시간량 / 1024 + 1)
...
static inline void __update_task_entity_contrib(struct sched_entity *se)
{
	...
	// se->avg.runnable_avg_sum: (&(kmem_cache#15-oX (struct task_struct))->se)->avg.runnable_avg_sum: 현재 task의 남아 있는 수행 시간량 / 1024
	// se->load.weight: (&(kmem_cache#15-oX (struct task_struct))->se)->load.weight: 1024
	contrib = se->avg.runnable_avg_sum * scale_load_down(se->load.weight);
	// contrib: 현재 task의 남아 있는 수행 시간량

	// se->avg.runnable_avg_period: (&(kmem_cache#15-oX (struct task_struct))->se)->avg.runnable_avg_period: 현재 task의 남아 있는 수행 시간량 / 1024
	contrib /= (se->avg.runnable_avg_period + 1);
	// contrib: 현재 task의 남아 있는 수행 시간량 / (현재 task의 남아 있는 수행 시간량 / 1024 + 1)

	// se->avg.load_avg_contrib: (&(kmem_cache#15-oX (struct task_struct))->se)->avg.load_avg_contrib,
	// contrib: 현재 task의 남아 있는 수행 시간량 / (현재 task의 남아 있는 수행 시간량 / 1024 + 1)
					  ...
					  int update_cfs_rq)
{
	 ...
	 */
	// se: &(kmem_cache#15-oX (struct task_struct))->se, entity_is_task(&(kmem_cache#15-oX (struct task_struct))->se): 1
	if (entity_is_task(se))
		// cfs_rq: [pcp0] &(&runqueues)->cfs
		// cfs_rq_clock_task([pcp0] &(&runqueues)->cfs): 현재의 schedule 시간값
	...
	// now: 현재의 schedule 시간값, &se->avg: &(&(kmem_cache#15-oX (struct task_struct))->se)->avg,
	// se->on_rq: (&(kmem_cache#15-oX (struct task_struct))->se)->on_rq: 1
	// __update_entity_runnable_avg(현재의 schedule 시간값, &(&(kmem_cache#15-oX (struct task_struct))->se)->avg, 1): 0
...
// ARM10C 20171011
// cfs_rq: [pcp0] &(&runqueues)->cfs, sleep: 1
static void update_cfs_rq_blocked_load(struct cfs_rq *cfs_rq, int force_update)
{
	// NOTE:
	// 2번째 호출 되었을 때의 시간의 변화 값을 시간값x  라 가정하고 코드 분석

	// cfs_rq: [pcp0] &(&runqueues)->cfs, cfs_rq_clock_task([pcp0] &(&runqueues)->cfs): 현재의 schedule 시간값
	// cfs_rq: [pcp0] &(&runqueues)->cfs, cfs_rq_clock_task([pcp0] &(&runqueues)->cfs): 현재의 schedule 시간값+ 시간값x
	u64 now = cfs_rq_clock_task(cfs_rq) >> 20;
	// now: 현재의 schedule 시간값>> 20
	// now: 현재의 schedule 시간값 + 시간값x >> 20

	u64 decays;

	// now: 현재의 schedule 시간값>> 20, cfs_rq->last_decay: [pcp0] (&(&runqueues)->cfs)->last_decay: 0
	// now: 현재의 schedule 시간값 + 시간값x >> 20, cfs_rq->last_decay: [pcp0] (&(&runqueues)->cfs)->last_decay: 현재의 schedule 시간값>> 20
	decays = now - cfs_rq->last_decay;
	// decays: 현재의 schedule 시간값>> 20
	// decays: 시간값x

	// decays: 현재의 schedule 시간값>> 20, force_update: 1
	// decays: 시간값x, force_update: 0
	if (!decays && !force_update)
		return;

	// &cfs_rq->removed_load: [pcp0] &(&(&runqueues)->cfs)->removed_load
	// atomic_long_read([pcp0] &(&(&runqueues)->cfs)->removed_load): 0
	// &cfs_rq->removed_load: [pcp0] &(&(&runqueues)->cfs)->removed_load
	// atomic_long_read([pcp0] &(&(&runqueues)->cfs)->removed_load): 0
	...
	if (decays) {
		...
		// atomic64_add 에서 한일:
		// (&(&(&runqueues)->cfs)->decay_counter)->counter: 현재의 schedule 시간값>> 20 + 1

		// atomic64_add 에서 한일:
		// (&(&(&runqueues)->cfs)->decay_counter)->counter: 현재의 schedule 시간값>> 20 + 1 + 시간값x

		// cfs_rq->last_decay: [pcp0] (&(&runqueues)->cfs)->last_decay: 0, now: 현재의 schedule 시간값>> 20
		// cfs_rq->last_decay: [pcp0] (&(&runqueues)->cfs)->last_decay: 현재의 schedule 시간값>> 20, now: 현재의 schedule 시간값 + 시간값x >> 20
		cfs_rq->last_decay = now;
		// cfs_rq->last_decay: [pcp0] (&(&runqueues)->cfs)->last_decay: 현재의 schedule 시간값>> 20
		// cfs_rq->last_decay: [pcp0] (&(&runqueues)->cfs)->last_decay: 현재의 schedule 시간값 + 시간값x >> 20
	}
...
// ARM10C 20170208
// cfs_rq: [pcp0] &(&runqueues)->cfs, se: &(kmem_cache#15-oX (struct task_struct))->se, 0
// ARM10C 20170617
						  ...
						  int wakeup)
{
	 ...
	 */
	// se->avg.decay_count: (&(kmem_cache#15-oX (struct task_struct))->se)->avg.decay_count: 0
	if (unlikely(se->avg.decay_count <= 0)) {
		// se->avg.last_runnable_update: (&(kmem_cache#15-oX (struct task_struct))->se)->avg.last_runnable_update
		// cfs_rq: [pcp0] &(&runqueues)->cfs, rq_of([pcp0] &(&runqueues)->cfs): [pcp0] &runqueues,
		// rq_clock_task([pcp0] &runqueues): 현재의 schedule 시간값
		se->avg.last_runnable_update = rq_clock_task(rq_of(cfs_rq));
		// se->avg.last_runnable_update: (&(kmem_cache#15-oX (struct task_struct))->se)->avg.last_runnable_update: 현재의 schedule 시간값
	...
	// cfs_rq->runnable_load_avg: [pcp0] (&(&runqueues)->cfs)->runnable_load_avg: 0,
	// se->avg.load_avg_contrib: (&(kmem_cache#15-oX (struct task_struct))->se)->avg.load_avg_contrib:
	// 현재 task의 남아 있는 수행 시간량 / (현재 task의 남아 있는 수행 시간량 / 1024 + 1)
 ...
 */
// ARM10C 20171011
// cfs_rq: [pcp0] &(&runqueues)->cfs, se: &(kmem_cache#15-oX (struct task_struct) (pid: 1))->se, 1
						  ...
						  int sleep)
{
	...
	// cfs_rq->runnable_load_avg: [pcp0] (&(&runqueues)->cfs)->runnable_load_avg:
	// 현재 task의 남아 있는 수행 시간량 / (현재 task의 남아 있는 수행 시간량 / 1024 + 1)
	// se->avg.load_avg_contrib: (&(kmem_cache#15-oX (struct task_struct) (pid: 1))->se)->avg.load_avg_contrib
	// 현재 task의 남아 있는 수행 시간량 / (현재 task의 남아 있는 수행 시간량 / 1024 + 1)
	cfs_rq->runnable_load_avg -= se->avg.load_avg_contrib;
	// cfs_rq->runnable_load_avg: [pcp0] (&(&runqueues)->cfs)->runnable_load_avg:: 계산된 load avg 값
	...
	if (sleep) {
		...
		// cfs_rq->blocked_load_avg: [pcp0] (&(&runqueues)->cfs)->blocked_load_avg:
		// 현재 task의 남아 있는 수행 시간량 / (현재 task의 남아 있는 수행 시간량 / 1024 + 1)

		// se->avg.decay_count: (&(kmem_cache#15-oX (struct task_struct) (pid: 1))->se)->avg.decay_count,
		// cfs_rq->decay_counter: (&(&(&runqueues)->cfs)->decay_counter)->counter: 현재의 schedule 시간값>> 20 + 1 + 시간값x
		se->avg.decay_count = atomic64_read(&cfs_rq->decay_counter);
		// se->avg.decay_count: (&(kmem_cache#15-oX (struct task_struct) (pid: 1))->se)->avg.decay_count: 현재의 schedule 시간값>> 20 + 1 + 시간값x
...
// ARM10C 20170201
// cfs_rq: [pcp0] &(&runqueues)->cfs, se: &(kmem_cache#15-oX (struct task_struct))->se, flags: 0
// ARM10C 20170617
// cfs_rq: [pcp0] &(&runqueues)->cfs, se: &(kmem_cache#15-oX (struct task_struct))->se, flags: 0
static void
enqueue_entity(struct cfs_rq *cfs_rq, struct sched_entity *se, int flags)
{
	 ...
	 */
	// flags: 0, ENQUEUE_WAKEUP: 1, ENQUEUE_WAKING: 4
...
// 2017/06/24 시작
	...
	if (cfs_rq->nr_running == 1) {
		...
		// cfs_rq: [pcp0] &(&runqueues)->cfs
		check_enqueue_throttle(cfs_rq); // null function
	}
}
...
dequeue_entity(struct cfs_rq *cfs_rq, struct sched_entity *se, int flags)
{
	...
	// cfs_rq: [pcp0] &(&runqueues)->cfs, se: &(kmem_cache#15-oX (struct task_struct) (pid: 1))->se, flags: 1, DEQUEUE_SLEEP: 1
	dequeue_entity_load_avg(cfs_rq, se, flags & DEQUEUE_SLEEP);

	// dequeue_entity_load_avg 에서 한일:
	// delta: 현재의 schedule 시간 변화값은 signed 로 변경시 0 보다 큰 값으로 가정하고 코드 분석 진행
	//
	// (&(&(kmem_cache#15-oX (struct task_struct))->se)->avg)->last_runnable_update: 현재의 schedule 시간값
	//
	...
	// se->on_rq: (&(kmem_cache#15-oX (struct task_struct) (pid: 1))->se)->on_rq: 1
	se->on_rq = 0;
	// se->on_rq: (&(kmem_cache#15-oX (struct task_struct) (pid: 1))->se)->on_rq: 0

	// cfs_rq: [pcp0] &(&runqueues)->cfs, se: &(kmem_cache#15-oX (struct task_struct) (pid: 1))->se
	account_entity_dequeue(cfs_rq, se);

	// account_entity_dequeue 에서 한일:
	// [pcp0] (&(&(&runqueues)->cfs)->load)->weight: 0
	// [pcp0] (&(&(&runqueues)->cfs)->load)->inv_weight: 0
	// [pcp0] (&(&runqueues)->load)->weight: 0
	// [pcp0] (&(&runqueues)->load)->inv_weight: 0
...
{
	// rq->curr: [pcp0] (&runqueues)->curr
	struct task_struct *curr = rq->curr;
	// curr: [pcp0] (&runqueues)->curr
...
// 2017/02/08 시작
		...
		*/
		...
		// cfs_rq->h_nr_running: [pcp0] (&(&runqueues)->cfs)->h_nr_running: 0
		// cfs_rq->h_nr_running: [pcp0] (&(&runqueues)->cfs)->h_nr_running: 2
		cfs_rq->h_nr_running++;
		// cfs_rq->h_nr_running: [pcp0] (&(&runqueues)->cfs)->h_nr_running: 1
