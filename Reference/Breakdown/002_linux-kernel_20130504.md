...
## Issue (Non-clear)
- [x] **1. page frame의 경우 왜 4KB를 사용하는 것일까?** [[#5]](https://github.com/arm10c/linux-stable/issues/5)
...
- [ ] **2. Slab, Slub, Slob의 의미가 교재를 통해 이해하기 어려움**
 ...
 - [ ] **3. ELF format의 자세한 구조가 궁금하며, Code영역(.text)의 dynamic 변경이 가능한가?** 
    > 대다수의 인원이 불가능하다고 의견 제시, 소수 인원은 가능할 수도 있고 컴파일러 옵션의 라이브러리 영역에 대한 예를 들며 의견 제시함.
